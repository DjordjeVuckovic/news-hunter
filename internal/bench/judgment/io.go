...
func ReadFile(path string) (*JudgmentFile, error) {
...
func ReadFileIfExists(path string) (*JudgmentFile, error) {
...
func (w *IncrementalWriter) LoadPrior() (*JudgmentFile, error) {
...
func (w *IncrementalWriter) Append(_ QueryProgress, entry JudgmentEntry) error {
...
func (w *IncrementalWriter) Snapshot() *JudgmentFile { return &w.current }
